...
class Utils(object):
    ...
    #     torch.load(netD.state_dict(), '{0}/disc_{1}.pth'.format(path, epoch))
    #     torch.load(netG.state_dict(), '{0}/gen_{1}.pth'.format(path, epoch))
...
class Logger(object):
    ...
    def log_iteration_gan(self, epoch, d_loss, g_loss, real_score, fake_score, path=""):
